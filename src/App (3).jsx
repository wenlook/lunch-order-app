    ...
    <div>
      ...
      >
        ...
        <p className="text-[10px] text-[#B3A992] mt-2">
          ...
          share that partial name. Typing a name here only blocks that name
          — for a block that sticks even if they try a different name, use
          "Block [Name]" on one of their orders in the Orders tab instead.
        </p>
      </div>
